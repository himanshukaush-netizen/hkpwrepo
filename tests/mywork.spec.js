...
test("Upload file", async function ({ page }) {
  await page.goto("https://testautomationpractice.blogspot.com/");
  const fp = "C:\\CV\\HappiestMind\\AD\\UploadFilePW.txt";
...
test("Upload multiple files", async function ({ page }) {
  await page.goto("https://testautomationpractice.blogspot.com/");
  const fp1 = "C:\\CV\\HappiestMind\\AD\\UploadFilePW.txt";
  const fp2 = "C:\\CV\\HappiestMind\\AD\\UploadFilePW - Copy.txt";
